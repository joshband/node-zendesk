...
Person.prototype.listWithIdentifierQuery = function(person_id, identifier_query, cb) {
    this.request('GET', ['person', person_id, {identifier: identifier_query}], cb);
};
...
Person.prototype.listWithIdentifierQueryAndProfileFilter = function(person_id, identifier_query, filter, cb) {
    this.request('GET', ['person', person_id, {identifier: identifier_query}, {included_profiles: filter}], cb);
};

// ====================================== Delete Profile
Profiles.prototype.delete = function(person_id, cb) {
    this.request('DELETE', ['person', person_id], cb);
};

// ====================================== Delete Profile
Profiles.prototype.deleteWithIdentifierQuery = function(person_id, identifier_query, cb) {
    this.request('DELETE', ['person', person_id, {identifier: identifier_query}], cb);
};
